...
public class RegistroDeColetas {
    ...
    public int getCooperativaId() { return cooperativaId; }
    public LocalDate getData() { return data; }
    public void setRecolhido(Material m, double kg) { recolhido.put(m, kg); }
    public double totalKg() { return recolhido.values().stream().mapToDouble(Double::doubleValue).sum(); }
    public Map<Material, Double> getDetalhes() { return recolhido; }
